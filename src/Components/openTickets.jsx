...
export const OpenTickets = (props) => {
	...
	return(
			<>
				...
				{showTablet ? 
				<>
					<Tooltip label="View Open Tickets / Inquiries" hasArrow placement={"top"} >
						<Link onClick={ticketOnOpen}>5</Link>
					</Tooltip>
					<Modal isOpen={ticketIsOpen} onClose={ticketOnClose}>
						<ModalOverlay/>
						<ModalContent>
							<ModalHeader>Current Tickets / Inquiries</ModalHeader>
							<ModalCloseButton/>
							<ModalBody>
								<Accordion>
									<AccordionItem>
